...
remaining models hosted on [build.nvidia.com](https://build.nvidia.com):
...
Pass `model_providers` when you need non-default endpoints—for example OpenAI, OpenRouter, a managed
