...
#   - rewrite_supplement:         guidance injected via COL_DOMAIN_SUPPLEMENT
...
def _enrich_domain(row: dict[str, Any]) -> dict[str, Any]:
    ...
    row[COL_DOMAIN_SUPPLEMENT] = _DOMAIN_BY_ENUM[parsed_domain.domain].rewrite_supplement
    return row
