...
DOMAIN_METADATA: tuple[DomainMetadata, ...] = (
    ...
    DomainMetadata(
        ...
        quality_supplement="Focus on: what problem is being discussed, key actions taken, decisions made, and final outcomes or resolutions. Drop: greetings, sign-offs, small talk, exact phone numbers, ticket IDs, and email signatures unless truly critical for understanding.",
    ),
    DomainMetadata(
        ...
        quality_supplement="Focus on: product features, qualities, user experience, clear pros/cons, issues, and overall evaluation or recommendation. Drop: specific order IDs, store locations, shipping details, and identifying anecdotes about the reviewer or third parties.",
    ),
    DomainMetadata(
    ...
    DomainMetadata(
        domain=Domain.LEGAL,
        classification_description="Contracts, terms of service, court decisions, legal memos, statutory analysis.",
    ...
    DomainMetadata(
        ...
        quality_supplement="Focus on: step-by-step actions, prerequisites, warnings, and success criteria. Drop: personal narratives or identifiers that aren't needed to follow the procedure.",
    ),
    DomainMetadata(
    ...
    DomainMetadata(
        ...
        quality_supplement="Focus on: core claim, sentiment, and key entities or events referenced at an abstract level. Drop: handles, hashtags that encode identities, and specific URLs unless structurally essential.",
    ),
    DomainMetadata(
        ...
        quality_supplement="Focus on: questions, answers, decisions, commitments, and key reasoning steps. Drop: greetings, small talk, and side chatter that do not influence outcomes.",
    ),
    DomainMetadata(
        domain=Domain.OTHER,
