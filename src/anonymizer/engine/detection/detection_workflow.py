...
class EntityDetectionWorkflow:
    ...
    def _build_detection_spec(
        ...
        *,
        ...
        labels = _resolve_detection_labels(entity_labels, regex_rules=custom_rules)
...
- The template is the authoritative list of candidates to validate. Each entry's context_before, value, and context_after are contiguous text from the original input and identify that exact occurrence. Overlapping candidates cannot always all appear as inline tags, so validate every template entry using these fields even when its inline tag is absent from the input text.
...
{%- endif -%}
Template: {"decisions": [{"id": "first_name_3_7", "value": "name", "label": "first_name", "context_before": "My ", "context_after": " is Amy, 35 in San Diego, Califo", "decision": null, "proposed_label": null, "reason": null}, {"id": "first_name_11_14", "value": "Amy", "label": "first_name", "context_before": "My name is ", "context_after": ", 35 in San Diego, California.", "decision": null, "proposed_label": null, "reason": null}, {"id": "age_16_18", "value": "35", "label": "age", "context_before": "My name is Amy, ", "context_after": " in San Diego, California.", "decision": null, "proposed_label": null, "reason": null}, {"id": "country_22_31", "value": "San Diego", "label": "country", "context_before": "My name is Amy, 35 in ", "context_after": ", California.", "decision": null, "proposed_label": null, "reason": null}, {"id": "state_33_43", "value": "California", "label": "state", "context_before": "y name is Amy, 35 in San Diego, ", "context_after": ".", "decision": null, "proposed_label": null, "reason": null}]}
