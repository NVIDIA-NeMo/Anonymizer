...
7. **Iterate**
   ...
   - If quality is off, consult the relevant symptom in [`docs/troubleshooting.md`](../../../docs/troubleshooting.md) or the [published troubleshooting guide](https://nvidia-nemo.github.io/Anonymizer/dev/troubleshooting/). Apply the suggested setting change to the script, then re-preview.
