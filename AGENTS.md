...
- **`integrations/nemo-relay`** — independently locked NeMo Relay worker. It protects copied observability events without adding Relay dependencies to the main Anonymizer wheel.
