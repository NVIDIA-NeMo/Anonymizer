...
# SPDX-License-Identifier: Apache-2.0                                                                  
  ...
  from anonymizer.engine.constants import COL_DOMAIN, COL_DOMAIN_SUPPLEMENT,
  COL_DOMAIN_SUPPLEMENT_PRIVACY, COL_TEXT, _jinja                                                        
  ...
  def test_enrich_domain_privacy_populates_supplement_for_known_domain() -> None:                        
      result = _enrich_domain_privacy({COL_DOMAIN: {"domain": Domain.BIOGRAPHY, "domain_confidence":
  0.9}})                                                                                                 
  ...
  def test_domain_supplement_privacy_map_covers_all_domains() -> None:                                   
      for domain in Domain:
          assert domain in DOMAIN_SUPPLEMENT_PRIVACY_MAP, f"Missing privacy supplement for domain: 
  {domain}"                                                                                              
